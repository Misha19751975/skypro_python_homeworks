...
driver.maximize_window()
driver.get("http://the-internet.herokuapp.com/login")
input_name_f = driver.find_element(By.ID, "username")
input_name_f.send_keys("tomsmith")
sleep(2)
input_pass_f = driver.find_element(By.ID, 'password')
input_pass_f.send_keys("SuperSecretPassword!")
sleep(2)
button_f = driver.find_element(By.TAG_NAME, "button")
button_f.click()
